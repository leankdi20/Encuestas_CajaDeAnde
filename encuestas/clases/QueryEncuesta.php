...
class QueryEncuesta {
  ...
  public static function cargarCedula($conn, $encuesta) {
    ...
    $ced_req_tex = $encuesta["cedula_oblig"] == 1 ? " (formato 9 dígitos: XXXXXXXXX)" : " (formato 9 dígitos: XXXXXXXXX - opcional)";
    $on_key_up = "";
    if ($incluye_nombre) $on_key_up = " onkeyup='revisarCedula(this.value)' ";

    if ($incluye_cedula) {
			// valido la logitud del campo en el evento keypress porque el maxlength no entra al tener el evento keypress
      echo "
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <input type='number' class='form-control' autocomplete='off' name='cedula' placeholder='Cédula" . $ced_req_tex . "'" . $ced_req . $on_key_up . " 
  ...
  public static function cargarNombre($conn, $encuesta) {
    ...
    if ($incluye_nombre) {
      echo "
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <input type='text' class='form-control' autocomplete='off' id='nombre' name='nombre' placeholder='Nombre completo" . $nom_req_tex . "'" . $nom_req . " 
    ...
    if ($incluye_correo) {
      echo "
              <div class='col-12 col-md-6 " . ($incluye_cedula ? " d-none " : "") . "'>
                <div class='form-group'>
                  <input type='email' class='form-control' id='correo' name='correo' placeholder='Correo electrónico" . $correo_req_tex . "'" . $correo_req . ">
                </div>
              </div>";
    }
  }
  ...
  public static function cargarTelefono($conn, $encuesta) {
    ...
    if ($incluye_telefono) {
      echo "
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <input type='number' min='10000000' max='99999999' step='1' class='form-control' name='telefono' placeholder='Número telefónico" . $telefono_req_tex . "'" . $telefono_req . ">
                </div>
              </div>";
    }
  }
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' onchange='cambiarSucursal(this)' id='sucursal' name='sucursal'" . $suc_req . " " . $suc_read . ">
                    <option disabled selected hidden value=''>-- Sucursal --" . $suc_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' id='unidad' name='unidad'" . $uni_req . $uni_read . $uni_onchange . ">
                    <option disabled selected hidden value=''>-- Unidad --" . $uni_req_tex . "</option>";
        if ($unidad_id > 0)
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' id='agente' name='agente'" . $agente_req . " " . $age_read . ">
                    <option disabled selected hidden value=''>-- Agente --" . $agente_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' id='gestion' name='gestion'" . $ges_req . ">
                    <option disabled selected hidden value=''>-- Gestión --" . $ges_req_tex . "</option>";
  ...
  public static function cargarFechaNac($conn, $encuesta) {
    ...
    if ($incluye_fecha_nac) {
      echo "
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <input type='text' class='form-control' ". $min_date . $max_date ." name='fecha_nac' placeholder='Fecha de nacimiento" . $fec_nac_req_tex . "'" . $fec_nac_req . " 
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' name='estado_emp'" . $estado_emp_req . ">
                    <option " . $estado_emp_disabled . " selected value=''>-- Tipo accionista --" . $estado_emp_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' name='genero'" . $genero_req . ">
                    <option " . $genero_disabled . " selected value=''>-- Género --" . $genero_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' name='puesto'" . $puesto_req . ">
                    <option " . $puesto_disabled . " selected value=''>-- Puesto --" . $puesto_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' onchange='cambiarProvincia(this)' id='provincia' name='provincia'" . $ubicacion_req . ">
                    <option disabled selected hidden value=''>-- Provincia --" . $ubicacion_req_tex . "</option>";
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' onchange='cambiarCanton(this)' id='canton' name='canton'" . $ubicacion_req . ">
                    <option disabled selected hidden value=''>-- Cantón --" . $ubicacion_req_tex . "</option>
                  </select>
                </div>
              </div>
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' id='distrito' name='distrito'" . $ubicacion_req . ">
                    <option disabled selected hidden value=''>-- Distrito --" . $ubicacion_req_tex . "</option>
                  </select>
                </div>
              </div>";
    }
              ...
              <div class='col-12 col-md-6'>
                <div class='form-group'>
                  <select class='form-control' name='est_civil'" . $est_civil_req . ">
                    <option " . $est_civil_disabled . " selected value=''>-- Estado civil --" . $est_civil_req_tex . "</option>";
